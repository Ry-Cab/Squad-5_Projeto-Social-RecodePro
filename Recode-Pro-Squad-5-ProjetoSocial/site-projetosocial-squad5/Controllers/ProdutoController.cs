...
namespace site_projetosocial_squad5.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_produto,nome_produto,descricao_produto,preco_produto,FK_id_cadastro,FK_nome_negocio")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_produto,nome_produto,descricao_produto,preco_produto,FK_id_cadastro,FK_nome_negocio")] Produto produto)
        {
